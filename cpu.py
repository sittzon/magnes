...
class CpuR2A03 (threading.Thread):
  def __init__(self, memory, writeLock, readLock):
    ...
    self.ops = {
      '0x00' : self.BRK,
      '0x01' : self.ORA_INDX,
      '0x04' : self.NOP_UNOFFICIAL_ZP,
      '0x05' : self.ORA_ZP,
      '0x06' : self.ASL_ZP,
      '0x08' : self.PHP,
      '0x09' : self.ORA_IMM,
      '0x0a' : self.ASL_ACC,
      '0x0c' : self.NOP_UNOFFICIAL_ABS,
      '0x0d' : self.ORA_ABS,
      '0x0e' : self.ASL_ABS,
      '0x10' : self.BPL,
      '0x11' : self.ORA_INDY,
      '0x14' : self.NOP_UNOFFICIAL_ZPX,
      '0x15' : self.ORA_ZPX,
      '0x16' : self.ASL_ZPX,
      '0x18' : self.CLC,
      '0x19' : self.ORA_ABSY,
      '0x1a' : self.NOP_UNOFFICIAL_IMP,
      '0x1c' : self.NOP_UNOFFICIAL_ABSX,
      '0x1d' : self.ORA_ABSX,
      '0x1e' : self.ASL_ABSX,
      '0x20' : self.JSR,
      '0x21' : self.AND_INDX,
      ...
      '0x30' : self.BMI,
      '0x31' : self.AND_INDY,
      '0x34' : self.NOP_UNOFFICIAL_ZPX,
      '0x35' : self.AND_ZPX,
      '0x36' : self.ROL_ZPX,
      '0x38' : self.SEC,
      '0x39' : self.AND_ABSY,
      '0x3a' : self.NOP_UNOFFICIAL_IMP,
      '0x3c' : self.NOP_UNOFFICIAL_ABSX,
      '0x3d' : self.AND_ABSX,
      '0x3e' : self.ROL_ABSX,
      '0x40' : self.RTI,
      '0x41' : self.EOR_INDX,
      '0x44' : self.NOP_UNOFFICIAL_ZP,
      '0x45' : self.EOR_ZP,
      '0x46' : self.LSR_ZP,
      '0x48' : self.PHA,
      '0x49' : self.EOR_IMM,
      ...
      '0x50' : self.BVC,
      '0x51' : self.EOR_INDY,
      '0x54' : self.NOP_UNOFFICIAL_ZPX,
      '0x55' : self.EOR_ZPX,
      '0x56' : self.LSR_ZPX,
      '0x58' : self.CLI,
      '0x59' : self.EOR_ABSY,
      '0x5a' : self.NOP_UNOFFICIAL_IMP,
      '0x5c' : self.NOP_UNOFFICIAL_ABSX,
      '0x5d' : self.EOR_ABSX,
      '0x5e' : self.LSR_ABSX,
      '0x60' : self.RTS,
      '0x61' : self.ADC_INDX,
      '0x64' : self.NOP_UNOFFICIAL_ZP,
      '0x65' : self.ADC_ZP,
      '0x66' : self.ROR_ZP,
      '0x68' : self.PLA,
      '0x69' : self.ADC_IMM,
      ...
      '0x70' : self.BVS,
      '0x71' : self.ADC_INDY,
      '0x74' : self.NOP_UNOFFICIAL_ZPX,
      '0x75' : self.ADC_ZPX,
      '0x76' : self.ROR_ZPX,
      '0x78' : self.SEI,
      '0x79' : self.ADC_ABSY,
      '0x7a' : self.NOP_UNOFFICIAL_IMP,
      '0x7c' : self.NOP_UNOFFICIAL_ABSX,
      '0x7d' : self.ADC_ABSX,
      '0x7e' : self.ROR_ABSX,
      '0x80' : self.NOP_UNOFFICIAL_IMM,
      '0x81' : self.STA_INDX,
      '0x83' : self.SAX_UNOFFICIAL_INDX,
      '0x84' : self.STY_ZP,
      '0x85' : self.STA_ZP,
      '0x86' : self.STX_ZP,
      '0x87' : self.SAX_UNOFFICIAL_ZP,
      '0x88' : self.DEY,
      '0x8a' : self.TXA,
      '0x8c' : self.STY_ABS,
      '0x8d' : self.STA_ABS,
      ...
      '0xa1' : self.LDA_INDX,
      '0xa2' : self.LDX_IMM,
      '0xa3' : self.LAX_UNOFFICIAL_INDX,
      '0xa4' : self.LDY_ZP,
      '0xa5' : self.LDA_ZP,
      '0xa6' : self.LDX_ZP,
      '0xa7' : self.LAX_UNOFFICIAL_ZP,
      '0xa8' : self.TAY,
      '0xa9' : self.LDA_IMM,
      '0xaa' : self.TAX,
      '0xac' : self.LDY_ABS,
      '0xad' : self.LDA_ABS,
      '0xae' : self.LDX_ABS,
      '0xaf' : self.LAX_UNOFFICIAL_ABS,
      '0xb0' : self.BCS,
      '0xb1' : self.LDA_INDY,
      '0xb3' : self.LAX_UNOFFICIAL_INDY,
      '0xb4' : self.LDY_ZPX,
      '0xb5' : self.LDA_ZPX,
      '0xb6' : self.LDX_ZPY,
      '0xb7' : self.LAX_UNOFFICIAL_ZPY,
      '0xb8' : self.CLV,
      '0xb9' : self.LDA_ABSY,
      '0xba' : self.TSX,
      '0xbc' : self.LDY_ABSX,
      ...
      '0xd1' : self.CMP_INDY,
      '0xd5' : self.CMP_ZPX,
      '0xd4' : self.NOP_UNOFFICIAL_ZPX,
      '0xd6' : self.DEC_ZPX,
      '0xd8' : self.CLD,
      '0xd9' : self.CMP_ABSY,
      '0xda' : self.NOP_UNOFFICIAL_IMP,
      '0xdc' : self.NOP_UNOFFICIAL_ABSX,
      '0xdd' : self.CMP_ABSX,
      '0xde' : self.DEC_ABSX,
      '0xe0' : self.CPX_IMM,
      '0xe1' : self.SBC_INDX,
      ...
      '0xf1' : self.SBC_INDY,
      '0xf5' : self.SBC_ZPX,
      '0xf4' : self.NOP_UNOFFICIAL_ZPX,
      '0xf6' : self.INC_ZPX,
      '0xf8' : self.SED,
      '0xf9' : self.SBC_ABSY,
      '0xfa' : self.NOP_UNOFFICIAL_IMP,
      '0xfc' : self.NOP_UNOFFICIAL_ABSX,
      '0xfd' : self.SBC_ABSX,
      '0xfe' : self.INC_ABSX
      }
  ...
  def getABSY(self):
    adress1 = self.readWord(self.PC + 1)
    adress2 = (adress1 + self.regY) & 0xffff
    operand = self.readByte(adress2)
    self.PC += 3
    return adress1, adress2, operand
  ...
  def LAX_UNOFFICIAL_ZP(self):
    ...
    self.setZeroIfZero(operand)
    self.clock += 3
    self.printZP("*LAX", adress, operand)

  def LAX_UNOFFICIAL_ABS(self):
    adress, operand = self.getABS()
    self.regA = operand
    self.regX = operand
    self.setNegativeIfNegative(operand)
    self.setZeroIfZero(operand)
    self.clock += 4
    self.printABS("*LAX", adress, operand)

  def LAX_UNOFFICIAL_INDY(self):
